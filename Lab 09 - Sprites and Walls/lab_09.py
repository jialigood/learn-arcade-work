...
def main():
    ...
    answer = input(
        "In 2014 a red bull stunt pilot single handedly hover his helicopter next to the ocean and got a bucket of water setting numerous helicopter world records? ")
    if answer == number_false:
        print("Correct!")
        total_score += 1
        print("Your new score is", total_score)
